...
-- CreateIndex
CREATE UNIQUE INDEX "tenant_properties_id_key" ON "tenant_properties"("id");

-- CreateIndex
CREATE UNIQUE INDEX "tenant_properties_user_id_key" ON "tenant_properties"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "tenant_properties_property_id_key" ON "tenant_properties"("property_id");
